...
Doc.prototype.auto_bracket = function(n){
    ...
    if(previous_sibling && previous_sibling.nodeName == "e" && previous_sibling.textContent && numbers.includes(previous_sibling.textContent.slice(-1)) &&
      e0.textContent && numbers.includes(e0.textContent.charAt(0))){ // there are numbers before this node
        return true;
    }
