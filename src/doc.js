...
Doc.prototype.auto_bracket = function(n){
    ...
    if(previous_sibling && previous_sibling.nodeName == "e" && previous_sibling.textContent && "0123456789".includes(previous_sibling.textContent.slice(-1))){ // there are numbers before this node
        return true;
    }
