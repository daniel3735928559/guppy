...
GuppyDoc.prototype.get_content = function(t,r){
    ...
    else if(t == "eqns") {var l = GuppyAST.to_eqlist(this.syntax_tree());for(var e in l){console.log(JSON.stringify(l[e]));}; return GuppyAST.to_eqlist(this.syntax_tree());}
