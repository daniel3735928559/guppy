...
GuppyAST.to_xml = function(ast, symbols, symbol_to_node){
	...
	console.log("AS",args.length, args);
	for(var i = 0; i < args.length; i++){
	    console.log("LA",args[i]);
	...
	console.log("BASE", (new XMLSerializer()).serializeToString(base));
	return base;
    };
