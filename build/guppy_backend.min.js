...
GuppyAST.parse_e = function(tokens){
    ...
    s = symbol("(pass)", 60);
    s.led = mul;
    s.nud = function(){ console.log("THIS",JSON.stringify(this)); return this.args[0] };
