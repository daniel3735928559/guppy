...
GuppyBackend.prototype.event = function(name){
    var ans = this.events[name] || GuppySettings.config.events[name];
    console.log("ANSE",ans,this.events[name]);
    return ans;
