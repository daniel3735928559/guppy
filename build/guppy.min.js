...
var Doc = function(doc, type){
    ...
    if(this.root().hasAttribute("v") && this.root().getAttribute("v") != Version.DOC_VER)
	throw Version.DOC_ERROR;
    else
	this.root().setAttribute("v",Version.DOC_VER);
}
