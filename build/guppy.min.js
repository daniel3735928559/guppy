...
<h3>Settings</h3><table id=\"guppy_settings_table\"></table>";
	...
	*/
	...
	/**
	   ...
	   @constructor
	*/
	var Guppy$1 = function Guppy(el, config) {
	...
	Guppy$1.instances = new Map();
	Guppy$1.Doc = Doc;
	Guppy$1.active_guppy = null;
	Guppy$1.Symbols = Symbols;
	Guppy$1.Mousetrap = mousetrap_min;

	Guppy$1.make_button = function (cls, parent, cb) {
	...
	/**
	    ...
	    @param {string} [template] - The name of the template to use
	*/
	Guppy$1.add_global_symbol = function (name, symbol, template) {
	    if (template) {
	    ...
	    try {
	        for (var _iterator = Guppy$1.instances[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	...
	/**
	    ...
	    @param {string} name - The name of the symbol to remove
	*/
	Guppy$1.remove_global_symbol = function (name) {
	    if (Symbols.symbols[name]) {
	        ...
	        try {
	            for (var _iterator2 = Guppy$1.instances[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
	...
	*/
	Guppy$1.configure = function (name, val) {
	...
	/**
	   ...
	   @param {Object} val - The value associated with the named setting: 
	      ...
	      "cliptype": A string describing what gets placed on the system clipboard when content is copied from the editor.
	         ...
	         "latex": Use LaTeX rendering of editor content
	*/
	Guppy$1.prototype.configure = function (name, val) {
	    if (name in Settings.settings_options && Settings.settings_options[name].indexOf(val) == -1) {
	...
	*/
	Guppy$1.prototype.event = function (name, handler) {
	...
	/**
	   ...
	   @param {function} handler - The function that will be called to handle the given event
	*/
	Guppy$1.event = function (name, handler) {
	    if (Settings.config.valid_events.indexOf(name) == -1) {
	        throw "Valid events are " + JSON.stringify(Settings.config.valid_events);
	    }
	    if (name == "focus" && Settings.osk) {
	...
	*/
	...
	Guppy$1.prototype.is_changed = function () {
	...
	Guppy$1.prototype.recompute_locations_paths = function () {
	    var ans = [];
	    var bb = this.editor.getElementsByClassName("katex")[0];
	    if (!bb) return;
	    var rect = bb.getBoundingClientRect();
	...
	Guppy$1.get_loc = function (x, y, current_node, current_caret) {
	    var g = Guppy$1.active_guppy;
	    var min_dist = -1;
	    var mid_dist = 0;
	    var pos = "";
	    var opt = null;
	...
	Guppy$1.mouse_up = function () {
	    Guppy$1.kb.is_mouse_down = false;
	    var g = Guppy$1.active_guppy;
	    if (g) g.render(true);
	};

	Guppy$1.mouse_down = function (e) {
	    if (e.target.getAttribute("class") == "guppy-button") return;
	    var n = e.target;
	    Guppy$1.kb.is_mouse_down = true;
	    while (n != null) {
	        var instance = Guppy$1.instances.get(n);
	        if (instance) {
	            e.preventDefault();
	            var prev_active = Guppy$1.active_guppy;
	            var _iteratorNormalCompletion3 = true;
	            var _didIteratorError3 = false;
	            var _iteratorError3 = undefined;

	            try {
	                for (var _iterator3 = Guppy$1.instances[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
	            ...
	            var g = Guppy$1.active_guppy;
	            var b = Guppy$1.active_guppy.engine;
	            g.space_caret = 0;
	            if (prev_active == g) {
	                if (e.shiftKey) {
	                    g.select_to(e.clientX, e.clientY, true);
	                } else {
	                    var loc = Guppy$1.get_loc(e.clientX, e.clientY);
	                    if (!loc) return;
	    ...
	    try {
	        for (var _iterator4 = Guppy$1.instances[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
	...
	Guppy$1.mouse_move = function (e) {
	    var g = Guppy$1.active_guppy;
	    if (!g) return;
	    if (!Guppy$1.kb.is_mouse_down) {
	        var bb = g.editor;
	        var rect = bb.getBoundingClientRect();
	...
	Guppy$1.prototype.select_to = function (x, y, mouse) {
	    ...
	    var loc = Guppy$1.get_loc(x, y, sel_cursor, sel_caret);
	    if (!loc) return;
	    this.engine.select_to(loc, sel_cursor, sel_caret, mouse);
	};

	window.addEventListener("mousedown", Guppy$1.mouse_down, true);
	window.addEventListener("mouseup", Guppy$1.mouse_up, true);
	window.addEventListener("mousemove", Guppy$1.mouse_move, false);

	Guppy$1.prototype.render_node = function (t) {
	...
	/**
	    ...
	    elements)
	*/
	Guppy$1.prototype.render = function (updated) {
	...
	/**
	    ...
	    @memberof Guppy
	*/
	Guppy$1.prototype.latex = function () {
	...
	/**
	    ...
	    @memberof Guppy
	*/
	Guppy$1.prototype.xml = function () {
	...
	/**
	    ...
	    @memberof Guppy
	*/
	Guppy$1.prototype.syntax_tree = function () {
	...
	/**
	    ...
	    @memberof Guppy
	*/
	Guppy$1.prototype.equations = function () {
	...
	/**
	    ...
	    @memberof Guppy
	*/
	Guppy$1.prototype.text = function () {
	...
	/**
	    ...
	    @memberof Guppy
	*/
	Guppy$1.prototype.asciimath = function () {
	...
	/**
	    ...
	    @memberof Guppy
	*/
	Guppy$1.prototype.doc = function () {
	...
	/**
	    ...
	    @memberof Guppy
	*/
	Guppy$1.prototype.func = function (evaluators) {
	...
	/**
	    ...
	    @memberof Guppy
	*/
	Guppy$1.prototype.evaluate = function (evaluators) {
	...
	/**
	    ...
	    @memberof Guppy
	*/
	Guppy$1.prototype.symbols_used = function (groups) {
	...
	/**
	    ...
	    @memberof Guppy
	*/
	Guppy$1.prototype.vars = function () {
	...
	/**
	    ...
	    @memberof Guppy
	*/
	Guppy$1.prototype.import_text = function (text) {
	...
	/**
	    ...
	    @memberof Guppy
	*/
	Guppy$1.prototype.import_latex = function (text) {
	...
	/**
	    ...
	    @memberof Guppy
	*/
	Guppy$1.prototype.import_xml = function (xml) {
	...
	/**
	    ...
	    @memberof Guppy
	*/
	Guppy$1.prototype.import_syntax_tree = function (tree) {
	...
	/**
	    ...
	    @memberof Guppy
	*/
	Guppy$1.prototype.activate = function () {
	    var newly_active = !this.editor_active;
	    Guppy$1.active_guppy = this;
	    this.editor_active = true;
	...
	/**
	    ...
	    @memberof Guppy
	*/
	Guppy$1.prototype.deactivate = function () {
	    ...
	    Guppy$1.kb.shift_down = false;
	    Guppy$1.kb.ctrl_down = false;
	    Guppy$1.kb.alt_down = false;
	    this.render();
	...
	for (i = 65; i <= 90; i++) {
	    Guppy$1.kb.k_chars[String.fromCharCode(i).toLowerCase()] = String.fromCharCode(i).toLowerCase();
	    Guppy$1.kb.k_chars['shift+' + String.fromCharCode(i).toLowerCase()] = String.fromCharCode(i).toUpperCase();
	}

	// numbers

	for (i = 48; i <= 57; i++) {
	    Guppy$1.kb.k_chars[String.fromCharCode(i)] = String.fromCharCode(i);
	}Guppy$1.register_keyboard_handlers = function () {
	    ...
	    for (name in Symbols.symbols) {
	        ...
	        if (s.keys) for (i = 0; i < s.keys.length; i++) {
	            Guppy$1.kb.k_syms[s.keys[i]] = s.attrs.type;
	        }
	    }
	    for (i in Guppy$1.kb.k_chars) {
	        mousetrap_min.bind(i, function (i) {
	            return function () {
	                if (!Guppy$1.active_guppy) return true;
	                Guppy$1.active_guppy.temp_cursor.node = null;
	                if (Utils.is_text(Guppy$1.active_guppy.engine.current) && Guppy$1.kb.k_text[i]) {
	                    Guppy$1.active_guppy.engine.insert_string(Guppy$1.kb.k_text[i]);
	                } else {
	                    Guppy$1.active_guppy.engine.insert_string(Guppy$1.kb.k_chars[i]);
	                }
	                Guppy$1.active_guppy.render(true);
	                return false;
	            };
	        }(i));
	    }for (i in Guppy$1.kb.k_syms) {
	        mousetrap_min.bind(i, function (i) {
	            return function () {
	                if (!Guppy$1.active_guppy) return true;
	                Guppy$1.active_guppy.temp_cursor.node = null;
	                ...
	                if (Utils.is_text(Guppy$1.active_guppy.engine.current)) {
	                    if (Guppy$1.kb.k_text[i]) Guppy$1.active_guppy.engine.insert_string(Guppy$1.kb.k_text[i]);
	                } else {
	                    Guppy$1.active_guppy.engine.space_caret = 0;
	                    //Guppy.active_guppy.engine.insert_symbol(Guppy.kb.k_syms[i]);
	                    Guppy$1.active_guppy.engine.insert_symbol(Symbols.lookup_type(Guppy$1.kb.k_syms[i]));
	                }
	                Guppy$1.active_guppy.render(true);
	                return false;
	            };
	        }(i));
	    }for (i in Guppy$1.kb.k_controls) {
	        mousetrap_min.bind(i, function (i) {
	            return function () {
	                if (!Guppy$1.active_guppy) return true;
	                ...
	                if (Utils.is_text(Guppy$1.active_guppy.engine.current) && Guppy$1.kb.k_text[i]) {
	                    ...
	                    Guppy$1.active_guppy.engine.space_caret = 0;
	                    Guppy$1.active_guppy.engine[Guppy$1.kb.k_controls[i]]();
	                    Guppy$1.active_guppy.temp_cursor.node = null;
	                }
	                Guppy$1.active_guppy.render(["up", "down", "right", "left", "home", "end", "sel_left", "sel_right"].indexOf(i) < 0);
	                //Guppy.active_guppy.render(false);
	                return false;
	            };
	        }(i));
	    }for (i in Guppy$1.kb.k_text) {
	        if (!(Guppy$1.kb.k_chars[i] || Guppy$1.kb.k_syms[i] || Guppy$1.kb.k_controls[i])) {
	            mousetrap_min.bind(i, function (i) {
	                return function () {
	                    if (!Guppy$1.active_guppy) return true;
	                    Guppy$1.active_guppy.temp_cursor.node = null;
	...
	Guppy$1.initialised = false;

	Guppy$1.init = function () {
	    if (Guppy$1.initialised) return;
	    Settings.init(Symbols.symbols);
	    Guppy$1.register_keyboard_handlers();
	    Guppy$1.initialised = true;
	};
